...
CurvaExterior::CurvaExterior()
{
	...
	// 5 sectores * 2 triangulos * 3 vertices
	numVertices = 30;
}

void CurvaExterior::inicializar(unsigned int idTextura)
{
	texturaID = idTextura;
	...
	for (int i = 0; i < segmentos; i++)
	{
		...
		vertices.push_back(ax); vertices.push_back(0.0f); vertices.push_back(az); vertices.push_back(0.0f); vertices.push_back(v0);
		// Punto B (Externo Inicio)
		vertices.push_back(bx); vertices.push_back(0.0f); vertices.push_back(bz); vertices.push_back(1.0f); vertices.push_back(v0);
		// Punto C (InternoFin)
		vertices.push_back(cx); vertices.push_back(0.0f); vertices.push_back(cz); vertices.push_back(0.0f); vertices.push_back(v1);

		// Triangulo 2
		// Punto B (Externo Inicio)
		vertices.push_back(bx); vertices.push_back(0.0f); vertices.push_back(bz); vertices.push_back(1.0f); vertices.push_back(v0);
		// Punto D (Externo Fin)
		vertices.push_back(dx); vertices.push_back(0.0f); vertices.push_back(dz); vertices.push_back(1.0f); vertices.push_back(v1);
		// Punto C (Interno Fin)
		vertices.push_back(cx); vertices.push_back(0.0f); vertices.push_back(cz); vertices.push_back(0.0f); vertices.push_back(v1);
...
void CurvaExterior::dibujar(unsigned int shaderProgramID)
{
